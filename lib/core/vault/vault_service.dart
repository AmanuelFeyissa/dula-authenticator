...
class VaultService {
  ...
  Future<MasterKey> initialize(String password) async {
    ...
    await _store.write(
      metaKey,
      VaultMeta(version: VaultMeta.currentVersion, kdfParams: _params).toJson(),
    );
  ...
  Future<bool> changeCredential({
    ...
    try {
      ...
      await _store.write(
        metaKey,
        VaultMeta(version: VaultMeta.currentVersion, kdfParams: _params)
            .toJson(),
      );
    } catch (_) {
      return false;
